...
namespace Greedy.Architecture.Drawing
{
	public sealed class GreedyWindow : Form
	{
		...
		private void InvalidateViews()
		{
			...
			if (currentPathFinder is My_GreedyPathFinder)
		...
		{
			if (currentPathFinder == null || currentPathFinder is My_NotGreedyPathFinder)
			{
				return new My_GreedyPathFinder();
			}
			...
			return new My_NotGreedyPathFinder();
		}
